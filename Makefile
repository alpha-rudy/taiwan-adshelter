...
$(BUILD_DIR)/$(MAP_NAME)_KMEANS_Z%.osm: $(BUILD_DIR)/$(MAP_NAME).osm tools/cluster_ads_kmeans.py
	python3 tools/cluster_ads_kmeans.py $< --output-dir $(BUILD_DIR) --zoom-levels $*
